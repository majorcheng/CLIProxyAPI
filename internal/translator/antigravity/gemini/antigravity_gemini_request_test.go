...
func TestConvertGeminiRequestToAntigravity_ReplacesExistingSignatureForNonClaudeModel(t *testing.T) {
	// 非 Claude Gemini 模型的 functionCall 统一写入 skip sentinel，避免上游校验旧签名。
	...
	// Check that existing thoughtSignature is replaced by skip sentinel
