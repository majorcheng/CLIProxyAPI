...
type disabledFlagTokenStorage struct {
	meta map[string]any
}

func (s *disabledFlagTokenStorage) SetMetadata(meta map[string]any) {
	s.meta = meta
}

func (s *disabledFlagTokenStorage) SaveTokenToFile(authFilePath string) error {
...
func TestFileTokenStoreSavePersistsDisabledFlagForTokenStorage(t *testing.T) {
	...
	auth := &cliproxyauth.Auth{
		...
		Disabled: true,
		Storage:  &disabledFlagTokenStorage{},
