...
func (s *Server) setupRoutes() {
	...
	// 复用现有 Responses handler，给 chatgpt_base_url 风格客户端提供直连别名。
...
func (s *Server) registerManagementRoutes() {
	...
	mgmt.Use(s.managementAvailabilityMiddleware(), s.mgmt.Middleware())
	{
		...
		mgmt.GET("/routing/priority-zero-strategy", s.mgmt.GetPriorityZeroRoutingStrategy)
		mgmt.PUT("/routing/priority-zero-strategy", s.mgmt.PutPriorityZeroRoutingStrategy)
		mgmt.PATCH("/routing/priority-zero-strategy", s.mgmt.PutPriorityZeroRoutingStrategy)
		...
		mgmt.POST("/auth-files/codex/refresh", s.mgmt.RefreshCodexAuthFile)
